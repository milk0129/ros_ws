...
class TfBroadcaster(Node):
    ...
    def load_map(self, pgm_file_path, yaml_file_path):
        ...
        try:
            ...
            self.origin = yaml_data.get('origin', [-237.63145, -327.0553, 0.0])
    ...
    def publish_occupancy_grid_callback(self):
        ...
        grid_msg.info.origin.position.x = latitude
        grid_msg.info.origin.position.y = longitude
        grid_msg.info.origin.position.z = altitude
    ...
    def broadcast_transform(self, gps_lat, gps_lon, gps_alt):
        ...
        t_map_to_utm.transform.translation.z = gps_alt
