...
class TfBroadcaster(Node):
    def __init__(self):
        ...
        self.marker_timer = self.create_timer(3.1, self.publish_marker_array)  # 1초마다 발행  
    ...
    def publish_marker_array(self):
        ...
        for i in range(5):
            ...
            # 마커의 위치 설정
            marker.pose.position.x = i * latitude
            marker.pose.position.y = i * longitude
            ...
            # 마커 수명 설정 (0이면 무한)
            marker.lifetime = Duration(sec=0, nanosec=0)  # 수정된 부분
