...
class TfBroadcaster(Node):
    def __init__(self):
        ...
        # PGM 및 YAML 파일 경로 설정
        self.pgm_file_path = ('/home/hgy/sj_ws/src/local_pgm/map/empty_map.pgm')
        self.yaml_file_path = ('/home/hgy/sj_ws/src/local_pgm/map/empty_map.yaml')
    ...
    def update_visualization_markers(self, coordinates):
        ...
        for i, (lat, lon) in enumerate(coordinates):
            ...
            visual_marker.scale.x = 0.001
            visual_marker.scale.y = 0.001
            visual_marker.scale.z = 0.001
